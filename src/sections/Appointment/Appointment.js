...
const Appointment = () => {
    ...
    const reviewUrl = "https://search.google.com/local/writereview?placeid=ChIJjfu4Xop57jkR019nRoI7odQ"; // Your Google Review Link
                        ...
                        <div className="google-map">
                            ...
                            <div className="google-review-btn">
                                <a 
                                    ...
                                    className="btn mt-3"
                                   style={{ backgroundColor: "#583FBC", color: "white" }}
                                >

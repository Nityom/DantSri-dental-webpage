   ...
   <section className="service-banner-section section-common section-bg" itemScope itemType="https://schema.org/MedicalBusiness">
    <div className="container">
     {services.map((service, idx) => (
      <article
       className={`row align-items-center service-item ${idx % 2 !== 0 ? 'reverse' : ''}`}
       key={idx}
       itemScope
       itemType="https://schema.org/MedicalProcedure"
      >
       <div
        className={`col-lg-5 col-md-6 ${idx % 2 !== 0 ? 'order-lg-2' : ''}`}
        data-aos="fade-up"
       ...
       <div
        className={`col-lg-7 col-md-6 ${idx % 2 !== 0 ? 'order-lg-1' : ''}`}
        data-aos="fade-up"
        data-aos-duration="2000"
       >
